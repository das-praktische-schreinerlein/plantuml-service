...
rem TODO
set YAIOAPP=%BASEPATH%..\dist\yaio-plantuml-service-full.jar
set APPPROPAGATOR=%BASEPATH%..\sbin\apppropagator.jar
set CP="%YAIOAPP%;%APPPROPAGATOR%;"
set CFGFILE=%BASEPATH%..\config\plantuml-application.properties
...
rem set progs
set PROG_APP=de.yaio.services.plantuml.server.PlantumlApplication
